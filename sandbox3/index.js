...
const setCreateRecipe = (user) => {
    ...
    let addDirectionBtn = document.getElementById('addProcedure');
    let ingredients = [];
    let directions = [];
    ...
    let clearDirectionInput = () => {
        document.getElementById('procedureText').value = '';
    }
    ...
    let clearRecipeForm = () => {
        ...
        document.getElementById('procedureItems').innerHTML = '';
    ...
    let addDirection = () => {
        let directionStep = document.getElementById('procedureText').value;
        ...
        if (directionStep !== '') {
            ...
            document.getElementById('procedureItems').appendChild(newLI);
